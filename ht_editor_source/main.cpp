...
static void EditorInit(DS_Arena* persist, EditorState* s) {
	...
	OS_ReadEntireFile(persist, HATCH_DIR "/ht_utils/fire/fire_ui/resources/roboto_mono.ttf", &roboto_mono_ttf);
	OS_ReadEntireFile(persist, HATCH_DIR "/ht_utils/fire/fire_ui/resources/fontello/font/fontello.ttf", &icons_ttf);
