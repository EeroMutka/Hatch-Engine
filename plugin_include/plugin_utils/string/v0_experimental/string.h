...
#ifndef HATCH_API_INCLUDED
#error <hatch_api.h> must be included before this file!
#endif
#ifndef BASIC_DATA_INCLUDED
#error <plugin_utils/basic_data/../basic_data.h> must be included before this file!
#endif
...
// String view literal macros - when using C++, you don't need these as string
// has a constructor that takes in a c-string to implicitly convert it.
#ifdef __cplusplus
#define STR_V(x)    string{(char*)x, sizeof(x)-1}
#define STR_VI(x)   string{(char*)x, sizeof(x)-1}
#else
#define STR_V(x)  (string){(char*)x, sizeof(x)-1}
#define STR_VI(x)           {(char*)x, sizeof(x)-1} // string literal that works in C initializer lists
#endif
...
typedef struct { string* data; int size; } STR_Array;
...
STR_API char* STR_ToC(void* allocator, string str); // Allocates a new string
STR_API string STR_ToV(const char* str); // Makes a string view into `str`

STR_API const char* STR_CloneC(void* allocator, const char* str); // Allocates a new string
STR_API string STR_Clone(void* allocator, string str); // Allocates a new string
STR_API void STR_Free(void* allocator, string str);

STR_API char* STR_FormC(void* allocator, const char* fmt, ...); // Allocates a new string
STR_API string STR_Form(void* allocator, const char* fmt, ...); // Allocates a new string
...
STR_API void STR_PrintV(STR_Builder* s, string str);
...
STR_API bool STR_ParseU64Ex(string s, int base, uint64_t* out_value);
// #define STR_ToU64(s, out_value) STR_ParseU64Ex(s, 10, out_value)

// * A single minus or plus is accepted preceding the digits
// * Works with any base up to 16 (i.e. binary, base-10, hex)
// * Underscores are allowed and skipped
STR_API bool STR_ParseI64Ex(string s, int base, int64_t* out_value);
STR_API bool STR_ParseI64(string s, int64_t* out_value);

STR_API bool STR_ParseFloat(string s, double* out);

STR_API string STR_IntToStr(void* allocator, int value);
STR_API string STR_IntToStrEx(void* allocator, uint64_t data, bool is_signed, int radix);
STR_API string STR_FloatToStr(void* allocator, double value, int min_decimals);
...
STR_API uint32_t STR_UTF8ToCodepoint(string str);
...
STR_API uint32_t STR_NextCodepoint(string str, int* byteoffset);

// Decrements `bytecounter`, then returns the character on it.
// Will returns 0 if byteoffset < 0
STR_API uint32_t STR_PrevCodepoint(string str, int* byteoffset);

STR_API int STR_CodepointCount(string str);

// -- String view utilities -------------

STR_API string STR_Advance(string* str, int size);

STR_API string STR_BeforeFirst(string str, uint32_t codepoint); // returns `str` if no codepoint is found
STR_API string STR_BeforeLast(string str, uint32_t codepoint);  // returns `str` if no codepoint is found
STR_API string STR_AfterFirst(string str, uint32_t codepoint);  // returns `str` if no codepoint is found
STR_API string STR_AfterLast(string str, uint32_t codepoint);   // returns `str` if no codepoint is found

STR_API bool STR_Find(string str, string substr, int* out_offset);
STR_API bool STR_FindC(string str, const char* substr, int* out_offset);
STR_API string STR_ParseUntilAndSkip(string* remaining, uint32_t codepoint); // cuts forward until `codepoint` or end of the string is reached and an empty string is returned
STR_API bool STR_FindFirst(string str, uint32_t codepoint, int* out_offset);
STR_API bool STR_FindLast(string str, uint32_t codepoint, int* out_offset);
STR_API bool STR_LastIdxOfAnyChar(string str, string chars, int* out_index);
STR_API bool STR_Contains(string str, string substr);
STR_API bool STR_ContainsC(string str, const char* substr);
STR_API bool STR_ContainsU(string str, uint32_t codepoint);

STR_API string STR_Replace(void* allocator, string str, string search_for, string replace_with);
STR_API string STR_ReplaceMulti(void* allocator, string str, STR_Array search_for, STR_Array replace_with);
STR_API string STR_ToLower(void* allocator, string str);
STR_API uint32_t STR_CodepointToLower(uint32_t codepoint);

STR_API bool STR_EndsWith(string str, string end);
STR_API bool STR_EndsWithC(string str, const char* end);
STR_API bool STR_StartsWith(string str, string start);
STR_API bool STR_StartsWithC(string str, const char* start);
STR_API bool STR_CutEnd(string* str, string end);
STR_API bool STR_CutEndC(string* str, const char* end);
STR_API bool STR_CutStart(string* str, string start);
STR_API bool STR_CutStartC(string* str, const char* start);

STR_API bool STR_Match(string a, string b);
STR_API bool STR_MatchC(const char* a, const char* b);
STR_API bool STR_MatchCaseInsensitive(string a, string b);
STR_API bool STR_MatchCaseInsensitiveC(const char* a, const char* b);

STR_API string STR_Slice(string str, int lo, int hi);
STR_API string STR_SliceBefore(string str, int mid);
STR_API string STR_SliceAfter(string str, int mid);
...
static STR_ASCIISet STR_ASCIISetMake(string chars) {
	STR_ProfEnter();
	STR_ASCIISet set = {0};
...
STR_API string STR_ParseUntilAndSkip(string* remaining, uint32_t codepoint) {
	string line = { remaining->data, 0 };
...
STR_API string STR_BeforeFirst(string str, uint32_t codepoint) {
	int offset = str.size;
...
STR_API string STR_BeforeLast(string str, uint32_t codepoint) {
	int offset = str.size;
...
STR_API string STR_AfterFirst(string str, uint32_t codepoint) {
	int offset = str.size;
	string result = str;
...
STR_API string STR_AfterLast(string str, uint32_t codepoint) {
	int offset = str.size;
	string result = str;
...
STR_API string STR_Slice(string str, int lo, int hi) {
	...
	string result = { str.data + lo, hi - lo };
	return result;
}

STR_API string STR_SliceAfter(string str, int mid) {
	STR_ASSERT(mid <= str.size);
	string result = { str.data + mid, str.size - mid };
	return result;
}

STR_API string STR_SliceBefore(string str, int mid) {
	STR_ASSERT(mid <= str.size);
	string result = { str.data, mid };
	return result;
}
...
STR_API bool STR_FindC(string str, const char* substr, int* out_offset) {
	string substr_v = STR_ToV(substr);
...
STR_API bool STR_EndsWithC(string str, const char* end) { return STR_EndsWith(str, STR_ToV(end)); }
STR_API bool STR_StartsWithC(string str, const char* start) { return STR_StartsWith(str, STR_ToV(start)); }
STR_API bool STR_CutEndC(string* str, const char* end) { return STR_CutEnd(str, STR_ToV(end)); }
STR_API bool STR_CutStartC(string* str, const char* start) { return STR_CutStart(str, STR_ToV(start)); }
...
/*STR_API STR_RangeArray STR_Split(STR_Allocator *allocator, string str, char character) {
	STR_ProfEnter();
	int required_len = 1;
...
STR_API string STR_FloatToStr(void* allocator, double value, int min_decimals) {
	...
	string value_str = { buffer, size };
	return STR_Clone(allocator, value_str);
}

STR_API string STR_IntToStr(void* allocator, int value) { return STR_IntToStrEx(allocator, value, true, 10); }
...
/*STR_API string STR_JoinN(STR_Allocator* allocator, STR_Array args) {
STR_ProfEnter();
int offset = 0;
...
STR_API char* STR_ToC(void* allocator, string str) {
	STR_ProfEnter();
...
STR_API string STR_ToV(const char* s) {
	string result = { (char*)s, (int)strlen(s) };
	return result;
}

STR_API string STR_Clone(void* allocator, string str) {
	char* data = (char*)STR_MemAlloc(allocator, str.size);
	memcpy(data, str.data, str.size);
	string result = { data, str.size };
	return result;
}
...
STR_API string STR_Advance(string* str, int size) {
	STR_ProfEnter();
	string result = STR_SliceBefore(*str, size);
...
STR_API string STR_ToLower(void* allocator, string str) {
	...
	string result = STR_Clone(allocator, str);
...
STR_API void STR_PrintVA(STR_Builder* s, const char* fmt, va_list args) {
	for (const char* c = fmt; *c; c++) {
		if (*c == '%') {
			...
			case 'v': {
				STR_PrintV(s, va_arg(args, string));
			} break;
			case '?': {
...
STR_API string STR_Form(void* allocator, const char* fmt, ...) {
	va_list args; va_start(args, fmt);
	STR_Builder builder = { allocator };
	STR_PrintVA(&builder, fmt, args);
	va_end(args);
...
STR_API void STR_PrintC(STR_Builder* s, const char* str) {
	string str_v = { str, (int)strlen(str) };
	STR_PrintV(s, str_v);
}
...
STR_API void STR_PrintU(STR_Builder* s, uint32_t codepoint) {
	char buffer[4];
	string str = { buffer, STR_CodepointToUTF8(buffer, codepoint) };
	STR_PrintV(s, str);
}
